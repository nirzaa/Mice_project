...
def wandb_sweep(num_boxes, idx, comb, number_combinations):
    lr = 1e-3
    batch_size = 32
    ...
    wandb.agent(sweep_id, entropy_run)

@gin.configurable
def entropy_run(max_epochs, freq_print, genom, weight_decay, num_samples, transfer_epochs, window_size=3, config=None):
    '''
